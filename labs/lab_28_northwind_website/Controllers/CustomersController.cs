...
{
    //Controller creates path to data
    public class CustomersController : Controller
    {
        private NorthwindEntities db = new NorthwindEntities();


        //path to customers ...localhost:48759/customers - will show all customers
        // GET: Customers
        ...
        //path to particular customer 5=id length.. localhost:48274/customers/details/ALFKI .. returns customer with ID ALFKI
